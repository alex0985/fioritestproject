/*global history */
sap.ui.define([
		"alex/fiori/FioriOnlineTraining/controller/BaseController",
		...
		"sap/ui/Device",
		"alex/fiori/FioriOnlineTraining/model/formatter",
		"alex/fiori/FioriOnlineTraining/model/grouper",
		"alex/fiori/FioriOnlineTraining/model/GroupSortState"
		...
		return BaseController.extend("alex.fiori.FioriOnlineTraining.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("alex.fiori.FioriOnlineTraining.view.ViewSettingsDialog", this);
