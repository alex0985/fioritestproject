sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("alex/fiori/FioriOnlineTraining/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#FioriOnlineTrainingFinalApp-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#FioriOnlineTrainingFinalApp-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("alex.fiori.FioriOnlineTraining.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["alex/fiori/FioriOnlineTraining/localService/mockserver"], function (mockserver) {
